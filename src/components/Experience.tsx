...
const Experience = () => {
  return (
    <section className="relative bg-[#0b0f19] text-white px-4 sm:px-6 py-20 lg:py-20 font-sans overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="hidden sm:block absolute left-1/2 top-0 h-full w-[2px] bg-gradient-to-b from-sky-400/40 to-cyan-400/10 transform -translate-x-1/2" />
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => {
              ...
              return (
                ...
                >
                  {/* Dot */}
                  <div className="hidden sm:block absolute left-1/2 transform -translate-x-1/2 bg-sky-400 w-3.5 h-3.5 rounded-full z-10 shadow-md" />

                  {/* Card */}
                  <div
                    className={`w-full sm:w-1/2 bg-gradient-to-br from-[#1e293b]/80 to-[#0f172a]/90 border border-sky-500/20 rounded-xl p-5 sm:p-6 shadow-md hover:shadow-sky-400/30 transition-all duration-300 ${
                  ...
                  >
                    ...
                    <p className="text-sky-300 text-sm font-mono mt-1">{exp.duration}</p>
